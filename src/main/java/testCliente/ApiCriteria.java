...
public class ApiCriteria {
	...
	public static void main(String[] args) {
		...
		log.debug("/n 1) Consulta de todas las Personas:");
		...
		mostrarlistaPersona(personas);
		
		/******************* cosulta por id de persona **************************/
	...
	private static void mostrarlistaPersona(List<Persona> personas) {
